    ...
    <section id='contactPage'>
        ...
        <div id='contact'>
          ...
          <form className='contactForm' ref={form} onSubmit={sendEmail}>
            <input type='text' className='name' placeholder='Your name goes here' name='user_name'/>
            <input type='email' className='email'  placeholder='Enter you email address' name='user_email'/>
